...
//       };
//     // Assuming "all blink" refers to an unknown/critical/urgent state that needs blinking
//     case 'critical risk': // You can adjust this to match your actual "all blink" trigger
//     case 'urgent risk':
//       return {
//         style: { color: 'red', fontWeight: 'bold' }, // Set color to red for critical
//         className: 'risk-blink risk-high', // Apply blink class
//       };
//     default:
//       // Default style if the risk level isn't recognized
//       return {
//         style: { color: '#000048', fontWeight: 'bold' },
//         className: '',
//       };
//   }
// };
